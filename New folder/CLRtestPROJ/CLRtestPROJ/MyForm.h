...
private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
	...
	this->Text = SearchThread->ThreadState.ToString();
}
...
private: Void LoadPic(System::Object^  sender, System::EventArgs^  e)
{
	if (Files->Count > 0)
	{
		...
		catch (const System::Exception^ ae)//System::OutOfMemoryException^ ae)////(const System::ArgumentException^ ae) //const std::exception&)
		{
